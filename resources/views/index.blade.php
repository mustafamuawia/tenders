...
<head>
  ...
  <!--[if lt IE 9]>
        ...
        <![endif]-->
  <link href="{{url('public/build/static/css/main.f855e6bc.css')}}" rel="stylesheet">
</head>
...
<body role="document">
  ...
  <script>
    ! function(c) {
      function e(e) {
        for (var t, r, n = e[0], o = e[1], u = e[2], i = 0, a = []; i < n.length; i++) r = n[i], f[r] && a.push(f[r][0]), f[r] = 0;
  ...
  <script src="{{url('public/build/static/js/main.c793c9cd.js')}}"></script>
</body>
